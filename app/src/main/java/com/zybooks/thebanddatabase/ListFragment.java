...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<Band> bandList = com.zybooks.thebanddatabase.BandDatabase.getInstance(getContext()).getBands();
        for (int i = 0; i < bandList.size(); i++) {
            ...
            Band band = com.zybooks.thebanddatabase.BandDatabase.getInstance(getContext()).getBand(i + 1);
